...
function AddImageModal({ showId }) {
  ...
  return (
    <div id="add-image-modal">
      ...
      <form className="add-image-form-box">
        <div className='add-image-form-inputs-image'>
          <div>
            <img
        ...
        <div className='add-delete-image-buttons-holder'>
          <button className='add-delete-image-buttons' onClick={onSubmit}>Add Image</button>
          <button className='add-delete-image-buttons' onClick={reset}>X</button>
        </div>
      </form>
      {/* </div> */}
    </div>
